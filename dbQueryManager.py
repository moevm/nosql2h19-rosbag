...
class dbQueryManager:
    ...
    def getMainInfo(self):
        # queryResult = self.collection.find({}, {"topics_list.msgs_list.msgs" : {"$slice": 10}})
...
if __name__ == "__main__":
    manager = dbQueryManager("bagfiles_test")
    manager.getNumberOfDocuments()
    
    listOfBags = manager.getMainInfo()
    print(listOfBags)
